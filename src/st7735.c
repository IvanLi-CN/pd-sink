...
static uint8_t _buffer[ST7735_WIDTH << 1] = {
...
static void SPI_init(void) {
  ...
  // Configure SPI
  SPI1->CTLR1 =
      SPI_CPHA_1Edge  // Bit 0     - Clock PHAse
      | SPI_CPOL_Low  // Bit 1     - Clock POLarity - idles at the logical low
                      // voltage
...
void tft_init(void) {
  ...
  //   write_data_8(ST7735_MADCTL_MY | ST7735_MADCTL_MV |
  //                ST7735_MADCTL_BGR);  // 0 - Horizontal
  // write_data_8(ST7735_MADCTL_BGR);                                        //
  // 1 - Vertical
  write_data_8(ST7735_MADCTL_MV | ST7735_MADCTL_MY |
               ST7735_MADCTL_RGB);  // 2 - Horizontal
  //  write_data_8(ST7735_MADCTL_MX |
  // ST7735_MADCTL_MY | ST7735_MADCTL_BGR);  // 3 - Vertical
